...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "text-3xl font-tajawal font-bold leading-none tracking-tight",
      className
    )}
    {...props}
  />
